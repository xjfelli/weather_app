...
class HomeHourlyTomorrowTimeListWidget extends StatelessWidget {
  final WeatherEntity weather;

  const HomeHourlyTomorrowTimeListWidget({super.key, required this.weather});
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
        ...
        itemCount: weather.hourly.timeTomorrow.length,
        itemBuilder: (context, index) {
          final time = weather.hourly.timeTomorrow[index];
